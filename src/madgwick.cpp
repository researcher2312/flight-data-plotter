...
float q0 = 1.0, q1, q2, q3;	// quaternion of sensor frame relative to auxiliary frame
...
void eulerAngles(float* roll, float* pitch, float* yaw){
    ...
    *yaw = atan2f((2*q1*q2 - 2*q0*q3), (2*q0*q0 + 2*q1*q1 -1));  // equation (7)
    *pitch = -asinf(2*q1*q3 + 2*q0*q2);                                  // equatino (8)
...
void get_quaternion(float* _q0, float* _q1, float* _q2, float* _q3)
{
	*_q0 = q0;
	*_q1 = q1;
	*_q2 = q2;
